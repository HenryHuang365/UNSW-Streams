...
"""
Testing the message pin function
"""
...
def test_message_pin_channel(clear_and_register):
    #Login First User
...
def test_message_pin_dm(clear_and_register):
    #Login First User
    resp = requests.post(config.url + 'auth/login/v2', json={
        "email": "first.person@email.com",
        "password": "password"
...
def test_message_multiple_pin_channel(clear_and_register):
    #Login First User
    resp = requests.post(config.url + 'auth/login/v2', json={
        "email": "first.person@email.com",
        "password": "password"
...
def test_message_multiple_pin_dm(clear_and_register):
    #Login First User
    resp = requests.post(config.url + 'auth/login/v2', json={
        "email": "first.person@email.com",
        "password": "password"
...
def test_invalid_message_id(clear_and_register):
    ...
    assert resp_pin.status_code == 400
...
def test_channel_invalid_permission_pin_message(clear_and_register):
...
def test_dm_invalid_permission_pin_message(clear_and_register):
